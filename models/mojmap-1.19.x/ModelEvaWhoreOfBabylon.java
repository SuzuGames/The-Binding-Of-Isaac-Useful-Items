...
public class ModelEvaWhoreOfBabylon<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "evawhoreofbabylon"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cabeza = partdefinition.addOrReplaceChild("cabeza",
				CubeListBuilder.create().texOffs(0, 15)
						...
						.addBox(2.0F, -8.0F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 59)
						.addBox(4.0F, -9.0F, -1.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(2, 60)
						.addBox(4.5F, -11.0F, -0.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 61)
						.addBox(4.0F, -13.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 13.0F, 0.0F));

		PartDefinition cube_r1 = cabeza.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 59)
						.addBox(13.0F, -9.0F, -1.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(2, 60)
						.addBox(13.5F, -11.0F, -0.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 61)
						.addBox(13.0F, -13.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(9.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
