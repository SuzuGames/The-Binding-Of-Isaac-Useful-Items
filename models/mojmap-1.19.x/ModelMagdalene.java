...
public class ModelMagdalene<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "magdalene"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cabeza = partdefinition.addOrReplaceChild("cabeza",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(28, 15)
						.addBox(-5.0F, -10.0F, -3.0F, 10.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(36, 41)
						.addBox(-5.0F, -9.0F, -5.0F, 10.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 44)
						.addBox(-6.0F, -9.0F, -3.0F, 12.0F, 6.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(26, 31)
