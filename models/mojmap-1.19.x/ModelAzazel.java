...
public class ModelAzazel<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "azazel"), "main");
	...
	public ModelAzazel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cabeza = partdefinition.addOrReplaceChild("cabeza",
				CubeListBuilder.create().texOffs(0, 15)
						...
						.addBox(-5.0F, -8.0F, -3.0F, 10.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(24, 15)
						.addBox(-4.0F, -3.0F, 4.0F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(36, 8)
						.addBox(-5.0F, -8.0F, -4.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(36, 8)
						.addBox(4.0F, -8.0F, -4.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(16, 31)
						.addBox(-4.0F, -8.0F, -5.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 31)
						.addBox(-4.5F, -8.0F, -4.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 8)
						.addBox(-3.0F, -8.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 31)
						.addBox(-2.0F, -8.0F, -5.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(38, 32)
						.addBox(-1.0F, -8.0F, -5.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 3)
						.addBox(0.0F, -8.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(38, 37)
						.addBox(1.0F, -8.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(41, 33)
						.addBox(3.0F, -7.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 21)
						.addBox(2.0F, -8.0F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 17)
						.addBox(-6.0F, -9.0F, -2.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(36, 0)
		...
		PartDefinition cube_r1 = cabeza.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(24, 17)
						.addBox(-6.0F, -9.0F, -2.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(34, 4)
						.addBox(-5.5F, -11.0F, -1.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(39, 12)
						.addBox(-4.0F, -13.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r2 = cabeza.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(20, 31).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 3.0F, 1.0F,
		...
		PartDefinition pierna_iz = partdefinition.addOrReplaceChild("pierna_iz", CubeListBuilder.create()
				.texOffs(34, 17).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 20.0F, 0.0F));

		PartDefinition pierna_de = partdefinition.addOrReplaceChild("pierna_de", CubeListBuilder.create().texOffs(28, 0)
		...
		PartDefinition cube_r3 = right_wing
				.addOrReplaceChild("cube_r3",
						CubeListBuilder.create().texOffs(20, 32).addBox(0.0F, -4.0F, 0.0F, 9.0F, 9.0F, 0.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition left_wing = partdefinition.addOrReplaceChild("left_wing",
				CubeListBuilder.create().texOffs(20, 32).addBox(0.0F, -3.0F, 0.0F, 9.0F, 9.0F, 0.0F,
						new CubeDeformation(0.0F)),
