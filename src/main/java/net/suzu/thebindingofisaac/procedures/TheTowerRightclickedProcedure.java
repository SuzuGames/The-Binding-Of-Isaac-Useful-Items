...
public class TheTowerRightclickedProcedure {
		...
		if (!world.isClientSide()) {
			...
			for (int index0 = 0; index0 < 6; index0++) {
				if (world instanceof ServerLevel _level)
					_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3((x + Mth.nextInt(RandomSource.create(), -10, 10)), (y + 10), (z + Mth.nextInt(RandomSource.create(), -10, 10))),
