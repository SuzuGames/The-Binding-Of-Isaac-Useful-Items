 ...
 *
 */
package net.suzu.thebindingofisaac;
...
import net.suzu.thebindingofisaac.init.TboiSuzuModFeatures;
...
@Mod("tboi_suzu")
public class TboiSuzuMod {
	public static final Logger LOGGER = LogManager.getLogger(TboiSuzuMod.class);
	public static final String MODID = "tboi_suzu";
