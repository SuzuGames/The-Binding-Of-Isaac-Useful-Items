...
public class JudasEntity extends TamableAnimal implements RangedAttackMob {
	public JudasEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TboiSuzuModEntities.JUDAS.get(), world);
	}

	public JudasEntity(EntityType<JudasEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		JudasTearEntity.shoot(this, target);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		JudasEntity retval = TboiSuzuModEntities.JUDAS.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(TboiSuzuModItems.CURVED_HORN.get()).contains(stack.getItem());
	}

	public static void init() {
		SpawnPlacements.register(TboiSuzuModEntities.JUDAS.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
