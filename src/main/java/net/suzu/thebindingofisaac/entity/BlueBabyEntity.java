...
public class BlueBabyEntity extends TamableAnimal implements RangedAttackMob {
	public BlueBabyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TboiSuzuModEntities.BLUE_BABY.get(), world);
	}
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		BlueBabyTearEntity.shoot(this, target);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BlueBabyEntity retval = TboiSuzuModEntities.BLUE_BABY.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(TboiSuzuModItems.MECONIUM.get()).contains(stack.getItem());
	}
