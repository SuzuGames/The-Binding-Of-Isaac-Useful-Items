...
public class TboiSuzuModTabs {
	public static final DeferredRegister<CreativeModeTab> REGISTRY = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, TboiSuzuMod.MODID);
	public static final RegistryObject<CreativeModeTab> TAROT_CARDS = REGISTRY.register("tarot_cards",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.tboi_suzu.tarot_cards")).icon(() -> new ItemStack(TboiSuzuModItems.TAROT_CARD.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(TboiSuzuModItems.CHARGED_THE_EMPRESS.get());
			})

					.build());
	public static final RegistryObject<CreativeModeTab> HEARTS = REGISTRY.register("hearts",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.tboi_suzu.hearts")).icon(() -> new ItemStack(TboiSuzuModItems.RED_HEART.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(TboiSuzuModItems.BLACK_HEART.get());
					...
					.build());
	public static final RegistryObject<CreativeModeTab> PILLS = REGISTRY.register("pills",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.tboi_suzu.pills")).icon(() -> new ItemStack(TboiSuzuModItems.PILL_1.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(TboiSuzuModItems.PILL_13.get());
					...
					.build());
	public static final RegistryObject<CreativeModeTab> PENNIES = REGISTRY.register("pennies",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.tboi_suzu.pennies")).icon(() -> new ItemStack(TboiSuzuModItems.PENNY.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(TboiSuzuModItems.DIME.get());
					...
					.build());
	public static final RegistryObject<CreativeModeTab> BOMBS = REGISTRY.register("bombs",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.tboi_suzu.bombs")).icon(() -> new ItemStack(TboiSuzuModItems.BOMB.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(TboiSuzuModItems.BIG_BOMB.get());
					...
					.build());
	public static final RegistryObject<CreativeModeTab> CHESTS = REGISTRY.register("chests",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.tboi_suzu.chests")).icon(() -> new ItemStack(TboiSuzuModBlocks.GOLDEN_CHEST.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(TboiSuzuModBlocks.ANGEL_CHEST.get().asItem());
					...
					.build());
	public static final RegistryObject<CreativeModeTab> KEYS = REGISTRY.register("keys",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.tboi_suzu.keys")).icon(() -> new ItemStack(TboiSuzuModItems.KEY.get())).displayItems((parameters, tabData) -> {
	...
	public static final RegistryObject<CreativeModeTab> ITEMS = REGISTRY.register("items",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.tboi_suzu.items")).icon(() -> new ItemStack(TboiSuzuModItems.GUPPYS_PAW.get())).displayItems((parameters, tabData) -> {
	...
	public static void buildTabContentsVanilla(BuildCreativeModeTabContentsEvent tabData) {
		...
		if (tabData.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS) {
			...
			tabData.accept(TboiSuzuModBlocks.BASEMENT_STRUCTURE_BLOCK.get().asItem());
			tabData.accept(TboiSuzuModBlocks.SPIKES.get().asItem());
			tabData.accept(TboiSuzuModBlocks.PINCHOS_OFF.get().asItem());
		}
