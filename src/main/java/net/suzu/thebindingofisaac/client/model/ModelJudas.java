...
public class ModelJudas<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("tboi_suzu", "model_judas"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = cabeza.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(32, 7).addBox(7.0F, -9.0F, -1.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3491F));
		PartDefinition cube_r2 = cabeza.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(32, 0).addBox(-1.0F, -12.0F, -2.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
